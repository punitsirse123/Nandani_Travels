      ...
      <div className="relative min-h-[85vh] flex flex-col pb-16">
        ...
        <main className="relative z-10 flex-1 flex flex-col lg:flex-row items-center lg:items-start justify-center p-6 max-w-[1400px] mx-auto w-full gap-12 lg:gap-16 pt-12 lg:pt-28">
          ...
          <div className="flex-1 text-left max-w-2xl flex flex-col justify-start pt-4">
            <div className="inline-block px-5 py-2.5 rounded-full bg-gold/10 border border-gold/30 text-gold text-xs font-bold tracking-[0.2em] uppercase mb-8 w-max shadow-[0_0_20px_rgba(212,175,55,0.15)] backdrop-blur-sm">
              Outstation Cab Service from Ahmedabad
            </div>
            <h1 className="text-5xl md:text-7xl lg:text-[75px] font-black text-transparent bg-clip-text bg-gradient-to-br from-white via-gray-100 to-gray-400 mb-6 tracking-tighter leading-[1.05] drop-shadow-2xl">
              {t.heroTitle}
            </h1>
            ...
            <div className="flex flex-col items-start gap-4">
              <div className="flex items-center gap-8 text-sm font-medium text-gray-400 bg-black/40 p-4 rounded-2xl w-max backdrop-blur-sm border border-white/5">
                <div className="flex items-center gap-3">
                  <span className="flex items-center justify-center w-6 h-6 rounded-full bg-gold/20"><span className="w-2 h-2 rounded-full bg-gold"></span></span> Instant Booking
                </div>
                <div className="flex items-center gap-3">
                  <span className="flex items-center justify-center w-6 h-6 rounded-full bg-gold/20"><span className="w-2 h-2 rounded-full bg-gold"></span></span> Transparent Fare
                </div>
              </div>
